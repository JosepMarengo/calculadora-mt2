...
document.getElementById('resultado1').textContent=`Resultado: ${resultado.toFixed(2)} `;
...
document.getElementById('resultado2').textContent=`Resultado ${resultado1.toFixed(2)}`;
});
...
document.getElementById('resultado3').textContent=`Resultado ${resultado3.toFixed(2)}`;
